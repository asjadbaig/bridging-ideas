...
if ( ! function_exists( 'bridging_ideas_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function bridging_ideas_posted_on() {
		...
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'bridging-ideas' ),
...
if ( ! function_exists( 'bridging_ideas_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function bridging_ideas_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'bridging-ideas' ),
						array(
							'span' => array(
								'class' => array(),
							),
